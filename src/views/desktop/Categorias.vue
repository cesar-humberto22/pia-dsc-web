        ...
        <div class="px-2 sm:flex sm:items-center sm:justify-between">
            <div>
                <div class="flex items-center gap-x-3">
                    <h2 class="text-lg font-medium text-gray-800">Categorías registradas</h2>
                </div>
                <p class="mt-1 text-sm text-gray-500">Actualiza, crea, eliminar categorías registrados en la plataforma.</p>
            </div>
            <div>
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="flex justify-between items-center p-5 rounded-t border-b">
                <h3 class="text-xl font-medium text-gray-900">
                    {{!selectedData? "Registrar": "Actualizar"}} categoría
                </h3>
            </div>
        ...
        <div class="bg-white rounded-lg md:max-w-md md:mx-auto p-4 fixed inset-x-0 bottom-0 z-50 mb-4 mx-4 md:relative">
            <div class="md:flex items-center">
                ...
                <div class="mt-4 md:mt-0 md:ml-6 text-center md:text-left">
                    <p class="font-bold">Eliminar categoría</p>
                    <p class="text-sm text-gray-700 mt-1">Esta seguro de eliminar permanentemente la categoría ??
                    </p>
                </div>
            </div>
    ...
    methods: {
        ...
        async handleSubmit(event) {
            ...
            if (this.selectedData) {
                ...
                const {
                    error
                } = await apiFetch("categoria/" + this.selectedData.id, {
